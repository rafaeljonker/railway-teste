...
import { getPropertyDetailsTool, searchPropertiesTool, } from "../property-search";
...
export const conciergeAgent = new Agent({
    ...
    description: "Concierge de propriedades premium em Balneário Camboriú. Assistente inteligente que ajuda investidores e corretores a encontrar imóveis de luxo através de busca conversacional, análise de mercado e ferramentas profissionais.",
    instructions: `
