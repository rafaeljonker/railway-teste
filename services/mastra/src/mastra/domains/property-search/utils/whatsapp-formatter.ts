...
export function formatPropertiesForWhatsApp(
  properties: Property[],
  maxResults = 4
): string {
...
export function formatPropertyDetailsForWhatsApp(property: Property): string {
...
function formatPropertyCard(property: Property): string {
